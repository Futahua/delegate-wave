...
The implemented normative rules and traceability tables are in [docs/BOOTSTRAP-SPEC.md](docs/BOOTSTRAP-SPEC.md), [docs/APPROVED-INTEGRATION-SPEC.md](docs/APPROVED-INTEGRATION-SPEC.md), [docs/CONTROL-API-SPEC.md](docs/CONTROL-API-SPEC.md), and [docs/HERMES-MCP-SPEC.md](docs/HERMES-MCP-SPEC.md). Hermes setup is in [docs/HERMES-MCP.md](docs/HERMES-MCP.md), with local-SDK evidence in [docs/HERMES-MCP-DOGFOOD.md](docs/HERMES-MCP-DOGFOOD.md) and live natural-language measurements in [docs/HERMES-LIVE-DOGFOOD.md](docs/HERMES-LIVE-DOGFOOD.md). PR #4 worker costs and review evidence are recorded in [docs/CONTROL-API-DOGFOOD.md](docs/CONTROL-API-DOGFOOD.md).
